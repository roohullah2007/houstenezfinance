                    ...
                    <header className="relative z-20">
                        <div className="mx-auto flex h-20 max-w-[1408px] items-center justify-between px-4 sm:px-6 lg:px-8">
                            <Link href="/" className="flex items-center gap-2">
                                <img src="/images/housten-logo.svg" alt="Houston EZ Finance" className="h-20 w-52 object-contain sm:h-24 sm:w-60 lg:h-28 lg:w-72" />
                            </Link>
                            <nav className="hidden items-center gap-8 lg:flex">
                                {navLinks.map((link) => (
                                    <Link key={link.label} href={link.href} className="text-sm font-medium text-white/80 transition hover:text-white">{link.label}</Link>
                                ))}
                            </nav>
                            <div className="flex items-center gap-3">
                                ...
                                <Link href="/sell-your-car">
                                    <button type="button" className="rounded-full px-5 py-2 text-sm font-semibold text-white shadow-lg hover:brightness-110" style={{ backgroundColor: ACCENT }}>Sell Car</button>
                                </Link>
                            </div>
                        </div>
                    </header>
                            ...
                            <div className="space-y-5">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">1234 Main St, Houston, TX 77002</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: `${ACCENT}15` }}>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">(713) 555-0123</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: `${ACCENT}15` }}>
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-gray-500">hello@houstonezfinance.com</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: `${ACCENT}15` }}>
                            ...
                            <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                                ...
                                <div className="grid gap-5 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" className={inputClass} placeholder="(713) 555-0123" value={data.phone} onChange={(e) => setData('phone', e.target.value)} />
